            ...
            <div class="card-body">
                ...
                <div class = "row">
                    <div class = "col-md-12 col-lg-6">
                        ...
                        <?= $view->downloadLinkBuilder($model->f_other_latest_payslip, 'Other Payslip', $model->id) ?>
                    </div>
                    <div class = "col-md-12 col-lg-6">
                        ...
                        <?= $view->downloadLinkBuilder($model->f_letter_indemnity, 'Letter of Indemnity ', $model->id) ?>
                        <?= $view->downloadLinkBuilder($model->f_flight_ticket, 'Flight Ticket', $model->id) ?>
                        <?= $view->downloadLinkBuilder($model->f_files, 'hello', $model->id) ?>
                    </div>
                </div>
