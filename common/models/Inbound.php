...
class Inbound extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['permanent_address', 'emergency_address', 'academic_research_title', 'campus_location', 'f_language_english_certificate', 'f_recommendation_letter', 'f_passport', 'f_latest_passport_photo', 'f_latest_academic_transcript', 'f_confirmation_letter', 'f_sponsorship_letter', 'f_offer_letter', 'f_proof_of_payment', 'token', 'temp', 'reason'], 'string'],
